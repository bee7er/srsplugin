...
curl -F "upload=@climatezilla_MAIN_03_srsTest.c4d.gz" -H "Content-Type: multipart/form-data" -X POST "https://3n3.477.mywebsitetransfer.com/projects?email=contact_bee@yahoo.com&userToken=fl9ltqesXqPi4EkSj8M498ZBYYq3WOcCCZ1A9fDYQlbeNEmdzyyf2rGFpNR0gDGB7IswfX3pRSLuoDBF&renderId=169"

...
curl -v -F "upload=@$8/frames_$5_to_$6_$4.gz" -H "Content-Type: multipart/form-data" http://srsapi.test/results
curl -v -F "upload=@$9/psds_$5_to_$6_$4.gz" -H "Content-Type: multipart/form-data" http://srsapi.test/results

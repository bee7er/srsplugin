...
curl -F "upload=@$8/frames_$5-$6_$4.tar.gz" -H "Content-Type: multipart/form-data" http://srsapi.test/results
curl -F "upload=@$9/psds_$5-$6_$4.tar.gz" -H "Content-Type: multipart/form-data" http://srsapi.test/results
